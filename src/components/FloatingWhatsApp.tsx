  ...
  return (
    <div className="fixed bottom-24 right-4 md:bottom-8 md:right-8 z-50 flex flex-col items-end gap-3">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="w-72 sm:w-80 bg-[#020617] border border-cyan-500/30 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden"
          >
            {/* Panel Header */}
      ...
      <button
        ...
        className="relative w-16 h-16 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/30 hover:shadow-[#25D366]/50 hover:scale-110 active:scale-95 transition-all duration-300"
      >
        {/* Pulse ring animation */}
        <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-25" />

        {/* Icon: toggle between message icon and close */}
